...
func (k employeeManagesEmployeePK) Hash(i uint32) uint32 {
	return relgomlib.Hash(i, k.bossID, k.minionID)
}
...
func (b *EmployeeManagesEmployeeBuilder) Apply() (PetShopModel, EmployeeManagesEmployee, error) {
	...
	model, _ := b.model.relations.Set(employeeManagesEmployeeKey, employeeManagesEmployeeRelationData{set})
...
func (d employeeManagesEmployeeRelationData) Size() uint64 {
	return d.set.Size()
}

// MarshalJSON implements json.Marshaler.
func (d employeeManagesEmployeeRelationData) MarshalJSON() ([]byte, error) {
	a := make([]*employeeManagesEmployeeData, 0, d.set.Size())
	for kv, m, has := d.set.FirstRestKV(); has; kv, m, has = m.FirstRestKV() {
		a = append(a, kv.Val.(*employeeManagesEmployeeData))
	}
...
func (d *employeeManagesEmployeeRelationData) UnmarshalJSON(data []byte) error {
	...
	set := seq.NewHashMap()
	for _, e := range a {
		set, _ = set.Set(e.employeeManagesEmployeePK, e)
	}
...
func (r EmployeeManagesEmployeeRelation) Insert() *EmployeeManagesEmployeeBuilder {
	return &EmployeeManagesEmployeeBuilder{model: r.model, apply: func(t *employeeManagesEmployeeData) (*seq.HashMap, error) {
		set, _ := r.model.GetEmployeeManagesEmployee().set.Set(t.employeeManagesEmployeePK, t)
		return set, nil
	}}
}
...
func (r EmployeeManagesEmployeeRelation) Update(t EmployeeManagesEmployee) *EmployeeManagesEmployeeBuilder {
	b := &EmployeeManagesEmployeeBuilder{employeeManagesEmployeeData: *t.employeeManagesEmployeeData, model: r.model, apply: func(t *employeeManagesEmployeeData) (*seq.HashMap, error) {
		set, _ := r.model.GetEmployeeManagesEmployee().set.Set(t.employeeManagesEmployeePK, t)
		return set, nil
	}}
...
func (r EmployeeManagesEmployeeRelation) Delete(t EmployeeManagesEmployee) (PetShopModel, error) {
	set, _ := r.model.GetEmployeeManagesEmployee().set.Del(t.employeeManagesEmployeePK)
	relations, _ := r.model.relations.Set(employeeManagesEmployeeKey, employeeManagesEmployeeRelationData{set: set})
