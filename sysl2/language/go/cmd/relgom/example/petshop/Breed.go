...
func (k breedPK) Hash(i uint32) uint32 {
	return relgomlib.Hash(i, k.breedID)
}
...
type BreedBuilder struct {
	...
	model PetShopModel
	mask  [1]uint64
	apply func(t *breedData) (*seq.HashMap, error)
}
...
func (b *BreedBuilder) Apply() (PetShopModel, Breed, error) {
	...
	model, _ := b.model.relations.Set(breedKey, breedRelationData{set})
...
func (r BreedRelation) Insert() *BreedBuilder {
	...
	return &BreedBuilder{model: model, apply: func(t *breedData) (*seq.HashMap, error) {
		t.breedID = int64(id)
		set, _ := r.model.GetBreed().set.Set(t.breedPK, t)
		return set, nil
	}}
}
...
func (r BreedRelation) Update(t Breed) *BreedBuilder {
	b := &BreedBuilder{breedData: *t.breedData, model: r.model, apply: func(t *breedData) (*seq.HashMap, error) {
		set, _ := r.model.GetBreed().set.Set(t.breedPK, t)
		return set, nil
	}}
