...
func (k employeePK) Hash(i uint32) uint32 {
	return relgomlib.Hash(i, k.employeeID)
}
...
type EmployeeBuilder struct {
	...
	model PetShopModel
	mask  [1]uint64
	apply func(t *employeeData) (*seq.HashMap, error)
}
...
func (b *EmployeeBuilder) Apply() (PetShopModel, Employee, error) {
	...
	model, _ := b.model.relations.Set(employeeKey, employeeRelationData{set})
...
func (r EmployeeRelation) Insert() *EmployeeBuilder {
	...
	return &EmployeeBuilder{model: model, apply: func(t *employeeData) (*seq.HashMap, error) {
		t.employeeID = int64(id)
		set, _ := r.model.GetEmployee().set.Set(t.employeePK, t)
		return set, nil
	}}
}
...
func (r EmployeeRelation) Update(t Employee) *EmployeeBuilder {
	b := &EmployeeBuilder{employeeData: *t.employeeData, model: r.model, apply: func(t *employeeData) (*seq.HashMap, error) {
		set, _ := r.model.GetEmployee().set.Set(t.employeePK, t)
		return set, nil
	}}
