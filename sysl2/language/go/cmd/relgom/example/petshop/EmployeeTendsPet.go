...
func (k employeeTendsPetPK) Hash(i uint32) uint32 {
	return relgomlib.Hash(i, k.employeeID, k.petID)
}
...
func (b *EmployeeTendsPetBuilder) Apply() (PetShopModel, EmployeeTendsPet, error) {
	...
	model, _ := b.model.relations.Set(employeeTendsPetKey, employeeTendsPetRelationData{set})
...
func (d employeeTendsPetRelationData) Size() uint64 {
	return d.set.Size()
}

// MarshalJSON implements json.Marshaler.
func (d employeeTendsPetRelationData) MarshalJSON() ([]byte, error) {
	a := make([]*employeeTendsPetData, 0, d.set.Size())
	for kv, m, has := d.set.FirstRestKV(); has; kv, m, has = m.FirstRestKV() {
		a = append(a, kv.Val.(*employeeTendsPetData))
	}
...
func (d *employeeTendsPetRelationData) UnmarshalJSON(data []byte) error {
	...
	set := seq.NewHashMap()
	for _, e := range a {
		set, _ = set.Set(e.employeeTendsPetPK, e)
	}
...
func (r EmployeeTendsPetRelation) Insert() *EmployeeTendsPetBuilder {
	return &EmployeeTendsPetBuilder{model: r.model, apply: func(t *employeeTendsPetData) (*seq.HashMap, error) {
		set, _ := r.model.GetEmployeeTendsPet().set.Set(t.employeeTendsPetPK, t)
		return set, nil
	}}
}
...
func (r EmployeeTendsPetRelation) Update(t EmployeeTendsPet) *EmployeeTendsPetBuilder {
	b := &EmployeeTendsPetBuilder{employeeTendsPetData: *t.employeeTendsPetData, model: r.model, apply: func(t *employeeTendsPetData) (*seq.HashMap, error) {
		set, _ := r.model.GetEmployeeTendsPet().set.Set(t.employeeTendsPetPK, t)
		return set, nil
	}}
